...
## Test Coverage
- **329 tests** across 31 test files
...
## Architecture Summary (Phase 7)
- **14 screens**: Home, Library, Intro, Calibration, Countdown, Game, Results, History, Settings, About, Landing, Share, Register, Research Console
- **1 plugin**: Reaction Light Test
- **5 scientific engines**: Reaction, Consistency, Fatigue, Scoring, Measurement Pipeline
- **11 core modules**: Session, Device, Calibration Cache, Repository, History, Event Bus, Auth, Offline, Telemetry, QR/Campaign/Referral/Consent, Research (Permissions, Filters, Charts, Cohort, Export, API)
...
## Last Commit
- **Hash:** 24f129e
- **Message:** `feat(phase-7): research console - role permissions, filters, charts, cohort builder, export, 9 dashboards`
- **Date:** 2026-07-17
...
## Last Snapshot
- `focus-v2-phase7-snapshot-2026-07-17.tar.gz`
